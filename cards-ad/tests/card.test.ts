...
describe('createEndGameOverlay', () => {
  ...
  it('applies "red" class for hearts and diamonds', () => {
    ...
    expect(createCardElement(heartCard).querySelector('.card')!.classList.contains('red')).toBe(true);
    expect(createCardElement(diamondCard).querySelector('.card')!.classList.contains('red')).toBe(true);
  });
  ...
  it('applies "black" class for spades and clubs', () => {
    ...
    expect(createCardElement(spadeCard).querySelector('.card')!.classList.contains('black')).toBe(true);
    expect(createCardElement(clubCard).querySelector('.card')!.classList.contains('black')).toBe(true);
  });
